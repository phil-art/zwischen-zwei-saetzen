...
Die Szenen liegen grundsätzlich bei 80–150 Wörtern; `S-T11-F01-C` hat nach der ausdrücklich freigegebenen Entfernung eines doppelten Satzes 77 Wörter. Wissen liegt bei 70–140 Wörtern, Praxis bei 70–120, Einstiege bei 35–65, Orientierung bei 30–90, Rückblick bei 35–75 und Abschluss bei 30–70. Die zwölf in der Nachprüfung beanstandeten A/B-Paare sind wieder den festgelegten Rollen zugeordnet; Pronomen-, Motiv- und Pausen-/Zustimmungsfehler sind gezielt korrigiert. In T04–T12 hat jede A/B/C-Variante einen eigenen rollengerechten Schluss; die 35 gleichförmigen „Von außen“-Einstiege der offenen Perspektive wurden individuell ersetzt. Figurenfakten und technische Perspektivrollen bleiben unverändert.

Eine anschließende gezielte Diff-Nachprüfung fand drei kleine Restgruppen. In dieser Folgekorrektur wurden die Diagramm-Alternativtexte von K05, K19 und K24 als vollständige Sätze neu gefasst, vier doppelte Schlusszusätze zusammengeführt und zwei unbelegte Formulierungen in `S-T05-F01-C` und `S-T11-F01-C` wieder geöffnet. Andere bereits geprüfte Texte wurden dabei nicht neu erzeugt.
